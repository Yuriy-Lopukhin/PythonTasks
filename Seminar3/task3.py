...
rus_dict = {1:'АВЕИНОРСТ',
      	...
      	8:'ШЭЮ',
      	10:'ФЩЪ'}
N = int(input('На какой раскладке играем? Русская - 0, Английская - 1: '))
word = input('Введите слово: ').upper()
if N == 1:
	print(f'Cлово {word} ощенивается в ', sum([k for i in word for k, v in eng_dict.items() if i in v]), 'очков')
elif N == 0:
	print(f'Слово {word} оценивается в ', sum([k for i in word for k, v in rus_dict.items() if i in v]), 'очков')
else:
    print('Неверно выбрана раскладка!')